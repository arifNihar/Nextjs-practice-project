...
export default function SubmitButton({ isLoading, title }) {
    return (
        <div className="mt-6 sm:col-span-1">
            {isLoading ? (
                <button disabled type="button" className="inline-flex items-center py-2.5 text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800"
                >
                    <svg
                        aria-hidden="true"
                        role="status"
                ...
                <button
                    type="submit"
                    className=" inline-flex items-center text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800"
                >
